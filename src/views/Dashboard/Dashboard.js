              ...
              <CardBody>
                ...
                <Table hover responsive className="table-outline mb-0 d-none d-sm-table">
                  ...
                  <tr>
                    ...
                    <th>User</th>
                    <th>Call usage</th>
                    <th className="text-center">Transcripts</th>
                    <th>Activity</th>
                  </tr>
                  </thead>
                  <tbody>
                  <tr>
                    ...
                    <td>
                      <div>Samantha Green</div>
                        <span>New</span> | Registered: Feb 1,2018
                    ...
                    <td>
                      <div className="clearfix">
                        ...
                        <div className="float-right">
                          <small className="text-muted">Jun 11, 2018 - Jul 10, 2018</small>
                        </div>
                      </div>
                      <Progress className="progress-xs" color="success" value="50"/>
                    </td>
                    <td className="text-center">
                      <i className="icon-docs" style={{fontSize: 24 + 'px'}}></i>
                    </td>
                    <td>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <div className="small text-muted">
                        ...
                        <span>Recurring</span> | Registered: Jan 15, 2018
                      </div>
                    </td>
                    <td>
                      <div className="clearfix">
                  ...
                  <tr>
                    ...
                    <td>
                      <div>Puja Rauniyar</div>
                      <div className="small text-muted">
                        <span>New</span> | Registered: Jan 11, 2018
                      </div>
                    </td>
                    <td>
                      <div className="clearfix">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <div className="small text-muted">
                        <span>New</span> | Registered: Jan 4, 2018
                      </div>
                    </td>
                    <td>
                      <div className="clearfix">
                  ...
                  <tr>
                    ...
                    <td>
                      <div>Brian Oliver</div>
                      <div className="small text-muted">
                        <span>New</span> | Registered: Jan 7, 2018
                      </div>
                    </td>
                    <td>
                      <div className="clearfix">
